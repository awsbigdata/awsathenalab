...
class exercise1():
    ...
    def createEx12(self):
        ...
        tablequery="CREATE external table lab_ex12(col1 string, col2 string, col3 string, col4 string, col5 string, col6 string) ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.RegexSerDe' WITH SERDEPROPERTIES ( 'input.regex' = '^([0-9.]+) ([\\\w.-]) ([\\\w.-]) \\\[([A-Za-z0-9:/]+ [+-][0-9]{4})\\\] \\\"(.+?)\\\" ([0-9]{3}) ([0-9]+)$') LOCATION"+"'s3://{}/{}ex12/'".format(self.s3bucket,self.prefix)
